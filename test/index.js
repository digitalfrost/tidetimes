...
var tideDataAsJSON  = '{"low":[{"time":"09:25","hight":"1.80"},{"time":"22:18","hight":"1.90"}],"high":[{"time":"03:05","hight":"3.90"},{"time":"15:58","hight":"3.80"}]}';
...
describe('format tide data', function(){
  ...
  it('should format tide data as JSON', function(){
      tides = new TideCrawler();
      JSON.stringify(tides._formatToJSON(tideData)).should.equal(tideDataAsJSON)
  });
});
